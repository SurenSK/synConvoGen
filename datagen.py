...
def generate_questions(task, is_safe): 
    ...
    if is_safe:
        ...
        prompt += f"Pretend to be engaged in a more innocent task. Do not mention anything that could be thought of as dangerous. Only say things that could be perceived as harmless."
